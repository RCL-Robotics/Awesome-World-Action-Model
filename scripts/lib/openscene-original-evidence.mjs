...
export async function snapshotOpenSceneEvidence({attempt,config,bundlePath,expectedSha256,helperPath,shouldStop,rendererCodeSha256}){
 ...
 for(const name of ['html-original-evidence.mjs','html-original-media.mjs','openscene-original-evidence.mjs','openscene-process.mjs','openscene-render.mjs','selected-html-source.mjs','selected-html-render.mjs'])await copyFile(new URL('./'+name,import.meta.url),join(attempt,name==='html-original-evidence.mjs'?'source-html.mjs':name));
