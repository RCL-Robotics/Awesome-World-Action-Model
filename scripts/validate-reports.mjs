...
console.log(`Validated ${illustrated.length} illustrated reports with ${illustrated.reduce((sum, report) => sum + report.visuals.length, 0)} original figures and tables.`);
