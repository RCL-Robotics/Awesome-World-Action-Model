...
const ENGLISH_LABELS = new Map(Object.entries({
  ...
  '3D/4D WAM': '3D/4D WAMs',
  'WAM + RL': 'WAMs + RL',
  'Memory WAM': 'Memory WAMs',
  'Multimodal / Tactile WAM': 'Multimodal / Tactile WAMs',
  'Real-Time / Efficient WAM': 'Real-Time / Efficient WAMs',
  'Latent / Representation WAM': 'Latent / Representation WAMs',
  'Navigation / Driving / Domain WAM': 'Navigation / Driving / Domain WAMs',
  'General WAM': 'General WAMs',
  '数据集': 'Datasets',
